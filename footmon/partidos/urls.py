...
from .views import partidos_equipo_anyo_torneo, goles_por_jugador_y_anyo, goles_en_propia_reibidos_por_equipo, goles_por_equipo_en_torneo, primer_tiro_penaltis, media_goles_de_penalti_por_jugador, media_victorias_equipo, pagina_principal
